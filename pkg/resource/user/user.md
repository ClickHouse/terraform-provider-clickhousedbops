...
- When importing an existing user configured with legacy fields, the resource will be lacking the `password_sha256_hash_wo_version` and the subsequent apply will recreate the user to set a password.
