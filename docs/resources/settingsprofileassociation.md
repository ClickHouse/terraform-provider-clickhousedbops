...
- `role_name` (String) Name of the SettingsProfileAssociation to associate the Settings profile to
- `user_name` (String) Name of the User to associate the Settings profile to
